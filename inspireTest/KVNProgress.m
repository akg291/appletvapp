...
+ (KVNProgress *)sharedView
{
	...
	dispatch_once(&onceToken, ^{
       // UIStoryboard *story=[UIStoryboard storyboardWithName:@"KVNProgressView" bundle:[NSBundle bundleForClass:[self class]]];
...
- (void)setupProgressCircle
{
	...
	UIBezierPath *circlePath = [UIBezierPath bezierPathWithArcCenter:center
															  radius:(radius - self.configuration.lineWidth)
														  startAngle:GLKMathDegreesToRadians(-190.0f)
															endAngle:GLKMathDegreesToRadians(275.0f)
														   clockwise:YES];
...
- (void)setupSuccessUI
{
	...
	[checkmarkPath moveToPoint:CGPointMake(CGRectGetWidth(self.circleProgressView.bounds) * 0.28f, CGRectGetHeight(self.circleProgressView.bounds) * 1.53f)];
	[checkmarkPath addLineToPoint:CGPointMake(CGRectGetWidth(self.circleProgressView.bounds) * 0.42f, CGRectGetHeight(self.circleProgressView.bounds) * 1.66f)];
	[checkmarkPath addLineToPoint:CGPointMake(CGRectGetWidth(self.circleProgressView.bounds) * 0.72f, CGRectGetHeight(self.circleProgressView.bounds) * 1.36f)];
...
- (void)setupErrorUI
{
	...
	[crossPath moveToPoint:CGPointMake(CGRectGetWidth(self.circleProgressView.bounds) * 0.72f, CGRectGetHeight(self.circleProgressView.bounds) * 1.27f)];
	[crossPath addLineToPoint:CGPointMake(CGRectGetWidth(self.circleProgressView.bounds) * 0.27f, CGRectGetHeight(self.circleProgressView.bounds) * 1.72f)];
	[crossPath moveToPoint:CGPointMake(CGRectGetWidth(self.circleProgressView.bounds) * 0.27f, CGRectGetHeight(self.circleProgressView.bounds) * 1.27f)];
	[crossPath addLineToPoint:CGPointMake(CGRectGetWidth(self.circleProgressView.bounds) * 0.72f, CGRectGetHeight(self.circleProgressView.bounds) * 1.72f)];
